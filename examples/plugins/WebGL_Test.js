/**
 * This example just uses the MDN tetrahedron sample https://github.com/mdn/dom-examples/tree/main/webgl-examples/tutorial/tetrahedron
 *
 * It imports glMatrix, creates an element on the page, and displays the example code.
 *
 * Super impratical, but I think it's kinda cool :P
 */

// URL_IMPORT https://cdnjs.cloudflare.com/ajax/libs/gl-matrix/3.4.2/gl-matrix-min.js

let tetrahedronRotation = 0.0;
const canvasElm = document.createElement("canvas");

canvasElm.id = "glcanvas";
canvasElm.style.position = "absolute";
canvasElm.style.width = "100vw";
canvasElm.style.height = "100vh";
